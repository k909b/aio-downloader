...
<!-- NAV START -->
<div dir="rtl" style="text-align:left; margin-top:10px;"><a href="https://github.com/k909b/aio-downloader/blob/main/telegram/content/archive_8.md" style="display:inline-block; padding:6px 12px; margin:0 4px; background-color:#2ea44f; color:white; text-decoration:none; border-radius:4px; font-weight:bold;">صفحه قبل</a> <a href="https://github.com/k909b/aio-downloader/blob/main/telegram/content/archive_10.md" style="display:inline-block; padding:6px 12px; margin:0 4px; background-color:#2ea44f; color:white; text-decoration:none; border-radius:4px; font-weight:bold;">صفحه بعد</a></div>
<!-- NAV END -->
